...
![Tests](https://img.shields.io/badge/tests-110%20passing-brightgreen) ![Dependencies](https://img.shields.io/badge/runtime%20deps-0-blue)
...
| **Returns & exchanges** (policy + link) | "↩️ Returns & exchanges" first asks which one you need, then gives the full policy (30-day / unused / original packaging) with the link and step-by-step instructions |
| **Exchange policy** (dedicated intent) | Ask *"what's your exchange policy?"*, *"can I swap this for a bigger size?"*, or *"my jacket is too small"* for the exchange-specific answer |
...
tests/                 # 110 Vitest tests: intent variations, exact mock-order logic,
...
110 tests cover: 5+ phrasing variations per core intent, the four order cases exactly as
